...
function handleKeyDown(event) 
{
    ...
    {
        camera.viewMatrix=mat4.translate(camera.viewMatrix, [0,0,5]);
    }
    ...
    {
        camera.viewMatrix=mat4.translate(camera.viewMatrix, [5,0,0]);
    }
...
function CreateFrameBufferObject(parWidth, parHeight)
{
    ...
    var depthTex = gl.createRenderbuffer();
    ...
    gl.framebufferRenderbuffer(gl.FRAMEBUFFER, gl.DEPTH_ATTACHMENT, gl.RENDERBUFFER, depthTex, 0);
